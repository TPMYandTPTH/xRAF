...
<ol>
  ...
  <li><strong>資格条件</strong>:
    <ul style="list-style-type: disc; margin-left: 20px;">
      <li>紹介された候補者は職位の最低要件を満たす必要があります。</li>
      <li>TPへの過去応募者や元TP従業員はボーナス対象外です。</li>
      <li>紹介対象はTPグループ現役従業員（正社員・パート・契約・臨時）ではありません。</li>
      <li>インターン／パートタイム職の紹介は対象外です。</li>
    </ul>
  </li>
  <li>紹介された友人が、採用目的でTPに個人情報提供に同意していることを確認します。</li>
  <li>プログラム運営のため、TPが個人データを収集・使用することに同意します。</li>
  <li>TPは本プログラムを予告なく変更または終了する権利を有します。</li>
...
<ol>
  ...
  <li><strong>資格要求</strong>:
    <ul style="list-style-type: disc; margin-left: 20px;">
      ...
      <li>曾申請過TP或前TP員工將不獲任何獎金。</li>
      <li>被推薦人不可為任何國家TP集團現職員工（全職、兼職、合約或臨時）。</li>
      <li>實習／兼職推薦不設獎金。</li>
    </ul>
  </li>
